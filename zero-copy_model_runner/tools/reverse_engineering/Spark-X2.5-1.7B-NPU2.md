# Reverse-Engineering Dossier: `Spark-X2.5-1.7B-NPU2.xclbin`

**Analyzed on**: 2026-09-13 01:47:32  
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/llamacpp-update/test_models/Spark-X2.5-1.7B-NPU2.xclbin`  
**SHA-256 Digest**: `acdda775c74cebb37d95988c540da38d220450c8ea7177c68d05f29515b0103c`  
**Container Size**: 343,752 bytes (335.70 KB)  
...
- **XRT Container UUID**: `304aab7e-a01a-9a35-8141-aaf3dcd56e14`
...
| **`IP_LAYOUT`** | Binary / XRT Header | `ip_layout.json` |
| **`CONNECTIVITY`** | Binary / XRT Header | `connectivity.json` |
...
- **Type**: `dpu`
- **Architecture Tag**: `spark2_5`
- **Model Dimensions**: Hidden Dim=`2048`, Heads=`8`, KV Heads=`2`, Layers=`28`
...
- **PDI UUID**: `38668b23-339b-4deb-a254-5b95c75af8d3`
- **Target PDI File**: `38668b23-339b-4deb-a254-5b95c75af8d3.pdi`
...
- **CDO Command Words**: `84,207 words` (336,828 bytes)

### CDO Hardware Instruction Breakdown

| Command Opcode / ID | Count | Purpose in Spatial Interconnect |
| :--- | :--- | :--- |
| **`NOP`** | 525 | Instruction alignment padding |
| **`AIE_STREAM_CONFIG`** | 11 | Inter-tile stream switch crossbar circuit configuration |
| **`DMA_XFER`** | 8 | Tile DMA channel transfer descriptor initialization |
...
| **`AIE_LOCK_INIT`** | 1 | Mutual exclusion lock / semaphore initialization |
| **`WRITE`** | 1 | Direct register / memory write to tile registers |
| **`CMD_0x02_e1`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x72_3a`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x23_6a`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x04_86`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x19_d1`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x1b_a1`** | 1 | Custom / Proprietary AIE microcode command |
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/llamacpp-update/test_models/Spark-X2.5-1.7B-NPU2.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/Spark-X2.5-1.7B-NPU2_extracted/38668b23-339b-4deb-a254-5b95c75af8d3.pdi` (337,184 bytes).
