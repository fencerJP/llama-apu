...
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-2B-NPU2/layer.xclbin`  
**SHA-256 Digest**: `5038f0b858910506b9f2b7ae41a5defe7dc3fa2570ce0321f600dbee0e43d4de`  
**Container Size**: 294,668 bytes (287.76 KB)  
...
- **XRT Container UUID**: `0cfab5cb-5512-4d42-7bd5-2327ea8dd548`
...
- **PDI UUID**: `a3c1af5d-d801-4aa0-80c5-a34157a78c7f`
- **Target PDI File**: `a3c1af5d-d801-4aa0-80c5-a34157a78c7f.pdi`
...
- **CDO Command Words**: `71,960 words` (287,840 bytes)
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-2B-NPU2/layer.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/qwen35_analysis/Qwen3.5-2B-NPU2/layer_extracted/a3c1af5d-d801-4aa0-80c5-a34157a78c7f.pdi` (288,208 bytes).
