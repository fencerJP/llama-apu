...
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-0.8B-NPU2/layer.xclbin`  
**SHA-256 Digest**: `494ebed4f9b56a250ba180ecb2278eaff983cbe0e1847d6913477c5051b78bde`  
**Container Size**: 294,460 bytes (287.56 KB)  
...
- **XRT Container UUID**: `801dc385-bc9b-c684-eb84-90a085d217c1`
...
- **PDI UUID**: `ceaa7a0d-c384-4973-a690-3270224100d4`
- **Target PDI File**: `ceaa7a0d-c384-4973-a690-3270224100d4.pdi`
...
- **CDO Command Words**: `71,908 words` (287,632 bytes)
...
| **`CMD_0x27_18`** | 1 | Custom / Proprietary AIE microcode command |
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-0.8B-NPU2/layer.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/qwen35_analysis/Qwen3.5-0.8B-NPU2/layer_extracted/ceaa7a0d-c384-4973-a690-3270224100d4.pdi` (288,000 bytes).
