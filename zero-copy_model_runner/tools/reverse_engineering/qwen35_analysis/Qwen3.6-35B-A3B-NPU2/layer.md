...
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.6-35B-A3B-NPU2/layer.xclbin`  
**SHA-256 Digest**: `b1b880272a091c9531dc3438fa274ea28b5d53bc653e54f0881418a31b231315`  
**Container Size**: 378,268 bytes (369.40 KB)  
...
- **XRT Container UUID**: `6ac6863b-5088-6148-66f9-b8b9f7bf4688`
...
- **PDI UUID**: `2ea62fa5-4fd1-4dd8-9a11-b8d2bc8ecdc0`
- **Target PDI File**: `2ea62fa5-4fd1-4dd8-9a11-b8d2bc8ecdc0.pdi`
...
- **CDO Command Words**: `92,860 words` (371,440 bytes)

### CDO Hardware Instruction Breakdown

| Command Opcode / ID | Count | Purpose in Spatial Interconnect |
| :--- | :--- | :--- |
| **`MASK_POLL`** | 1,178 | Hardware synchronization polling (barrier wait) |
| **`AIE_STREAM_CONFIG`** | 422 | Inter-tile stream switch crossbar circuit configuration |
| **`DMA_XFER`** | 413 | Tile DMA channel transfer descriptor initialization |
| **`MASK_WRITE`** | 218 | Atomic bitmasked register configuration (locks, stream switches) |
| **`NOP`** | 2 | Instruction alignment padding |
| **`CMD_0x96_18`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x95_80`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x48_18`** | 1 | Custom / Proprietary AIE microcode command |
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.6-35B-A3B-NPU2/layer.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/qwen35_analysis/Qwen3.6-35B-A3B-NPU2/layer_extracted/2ea62fa5-4fd1-4dd8-9a11-b8d2bc8ecdc0.pdi` (371,808 bytes).
