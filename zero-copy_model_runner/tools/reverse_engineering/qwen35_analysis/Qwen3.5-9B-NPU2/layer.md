...
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-9B-NPU2/layer.xclbin`  
**SHA-256 Digest**: `644463f960379f7ceb563cf2101234e97f5657a787c47853847b0f88759bfde7`  
**Container Size**: 333,996 bytes (326.17 KB)  
...
- **XRT Container UUID**: `6a1c5f2b-8351-47c3-fa5f-dcd791b7c56b`
...
- **PDI UUID**: `cb6073ab-952d-4e44-a2d5-ddde71271871`
- **Target PDI File**: `cb6073ab-952d-4e44-a2d5-ddde71271871.pdi`
...
- **CDO Command Words**: `81,795 words` (327,180 bytes)
...
| **`CMD_0x00_06`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x3f_ac`** | 1 | Custom / Proprietary AIE microcode command |
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-9B-NPU2/layer.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/qwen35_analysis/Qwen3.5-9B-NPU2/layer_extracted/cb6073ab-952d-4e44-a2d5-ddde71271871.pdi` (327,536 bytes).
