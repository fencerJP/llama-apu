# Reverse-Engineering Dossier: `layer.xclbin`

**Analyzed on**: 2026-09-13 01:47:26  
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3-8B-NPU2/layer.xclbin`  
**SHA-256 Digest**: `101e9884404f91813ea2e1ea00cfb1247b8566f7e86ca32dc923296144da8991`  
**Container Size**: 343,644 bytes (335.59 KB)  
...
- **XRT Container UUID**: `3b86784b-1b75-5001-7ddd-ccec80e2c290`
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3-8B-NPU2/layer.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/layer_extracted/38668b23-339b-4deb-a254-5b95c75af8d3.pdi` (337,184 bytes).
