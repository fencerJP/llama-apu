...
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-4B-NPU2/layer.xclbin`  
**SHA-256 Digest**: `9baa94b346fbe6701af487f7a45c6931466301cc4331204895d3a070509026c2`  
**Container Size**: 334,828 bytes (326.98 KB)  
...
- **XRT Container UUID**: `f0986c54-4ade-2552-763e-209e4bb11451`
...
- **PDI UUID**: `95999da0-c500-4028-8d8c-ef7a21c6265b`
- **Target PDI File**: `95999da0-c500-4028-8d8c-ef7a21c6265b.pdi`
...
- **CDO Command Words**: `82,003 words` (328,012 bytes)
...
| **`DMA_XFER`** | 2 | Tile DMA channel transfer descriptor initialization |
| **`NOP`** | 1 | Instruction alignment padding |
| **`CMD_0xc1_0e`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x25_0c`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x0a_14`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x1c_19`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x3f_eb`** | 1 | Custom / Proprietary AIE microcode command |
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-4B-NPU2/layer.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/qwen35_analysis/Qwen3.5-4B-NPU2/layer_extracted/95999da0-c500-4028-8d8c-ef7a21c6265b.pdi` (328,368 bytes).
