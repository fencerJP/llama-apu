# Reverse-Engineering Dossier: `GateDeltaNet_prefill.xclbin`

**Analyzed on**: 2026-09-14 05:13:06  
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-0.8B-NPU2/GateDeltaNet_prefill.xclbin`  
**SHA-256 Digest**: `5c40b5ea6e800351a73ee50ad3997e18dd1c4b02a1380416137b06ec80605fcc`  
**Container Size**: 228,636 bytes (223.28 KB)  
...
- **XRT Container UUID**: `8290da10-1f3d-f203-0cd7-7253e58a9851`
...
- **PDI UUID**: `3c9c0503-1f3b-41e8-841d-66f09086ebea`
- **Target PDI File**: `3c9c0503-1f3b-41e8-841d-66f09086ebea.pdi`
...
- **CDO Command Words**: `55,452 words` (221,808 bytes)
...
| **`DMA_XFER`** | 6 | Tile DMA channel transfer descriptor initialization |
| **`AIE_STREAM_CONFIG`** | 4 | Inter-tile stream switch crossbar circuit configuration |
| **`NOP`** | 4 | Instruction alignment padding |
| **`MASK_POLL`** | 1 | Hardware synchronization polling (barrier wait) |
| **`CMD_0x03_58`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x01_c4`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x00_10`** | 1 | Custom / Proprietary AIE microcode command |
| **`DMA_WRITE`** | 1 | Direct bulk data transfer into local 64 KB tile SRAM |
...
| `0x00203800` | Col 8 | `0x03800` | `MASK_WRITE` |
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-0.8B-NPU2/GateDeltaNet_prefill.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/qwen35_analysis/Qwen3.5-0.8B-NPU2/GateDeltaNet_prefill_extracted/3c9c0503-1f3b-41e8-841d-66f09086ebea.pdi` (222,176 bytes).
