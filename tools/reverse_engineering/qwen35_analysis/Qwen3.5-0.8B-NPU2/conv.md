# Reverse-Engineering Dossier: `conv.xclbin`

**Analyzed on**: 2026-09-14 05:13:06  
**Binary Source**: `/home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-0.8B-NPU2/conv.xclbin`  
**SHA-256 Digest**: `67ba4fe7740ab828c139dd4988a117873dbb8430925de709833894d805f3766c`  
**Container Size**: 386,380 bytes (377.32 KB)  
...
- **XRT Container UUID**: `9b28fb13-0f40-29d4-4c01-b23e23cc1308`
...
- **PDI UUID**: `d469dd4d-2183-46a8-86f8-4af2fc5477c6`
- **Target PDI File**: `d469dd4d-2183-46a8-86f8-4af2fc5477c6.pdi`
...
- **CDO Command Words**: `94,891 words` (379,564 bytes)
...
| **`DMA_XFER`** | 4 | Tile DMA channel transfer descriptor initialization |
| **`MASK_POLL`** | 1 | Hardware synchronization polling (barrier wait) |
| **`NOP`** | 1 | Instruction alignment padding |
| **`CMD_0x0f_d8`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x16_18`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0xd1_18`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x0f_c0`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x19_46`** | 1 | Custom / Proprietary AIE microcode command |
| **`CMD_0x29_70`** | 1 | Custom / Proprietary AIE microcode command |
...
| `0x00204a00` | Col 8 | `0x04a00` | `MASK_WRITE` |
...
1. **Embedding into `.q4nx` Header**:
   ```bash
   ./build/bin/apu-run -m <model>.gguf -x /home/fencer/.openclaw/workspace/projects/fastflowlm/src/xclbins/Qwen3.5-0.8B-NPU2/conv.xclbin --embed-xclbin
   ```
...
3. **Direct PDI Microcode Extraction**:
   - PDI extracted to: `/home/fencer/.openclaw/workspace/projects/zero-copy_model_runner/tools/reverse_engineering/qwen35_analysis/Qwen3.5-0.8B-NPU2/conv_extracted/d469dd4d-2183-46a8-86f8-4af2fc5477c6.pdi` (379,920 bytes).
